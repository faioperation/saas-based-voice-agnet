...
const Navbar = () => {
  ...
  return (
    <div className="sticky top-0 left-0 right-0 z-[100] bg-[#070B14] py-4 border-b border-sky-200">
      <Container>
        <motion.div
          ...
          >
            {user ? (
              <Link to={dashboardPath}>
                <button className="bg-sky-600 hover:bg-sky-700 rounded-full text-sky-950 font-bold text-base px-6 py-3 border border-[#0F42FF] cursor-pointer">
                  {dashboardLabel}
                </button>
              </Link>
            ) : (
                      ...
                      <Link
                        ...
                        className={`py-3 px-4 font-inter text-lg font-medium block rounded-xl transition-all ${
                          location.pathname === item.href
                            ...
                            : "text-sky-950 hover:bg-[#070B14] hover:text-[#0F42FF]"
                        }`}
                      >
                        {item.name}
                      </Link>
                      ...
                      <button
                        ...
                        className={`py-3 px-4 font-inter text-lg font-medium block rounded-xl transition-all w-full text-left ${
                          activeSection === item.href
                            ...
                            : "text-sky-950 hover:bg-[#0F42FF]/10 hover:text-[#0F42FF]"
                        }`}
                      >
                        {item.name}
                      </button>
                ...
                >
                  {user ? (
                    <Link to={dashboardPath} onClick={() => setOpen(false)}>
                      <button className="bg-sky-600 hover:bg-sky-700 rounded-full text-sky-950 font-bold text-base px-6 py-3 border border-[#0F42FF] w-full cursor-pointer">
                        {dashboardLabel}
                      </button>
                    </Link>
                  ) : (
