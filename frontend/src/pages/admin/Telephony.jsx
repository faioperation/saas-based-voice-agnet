  ...
  const columns = [
    ...
    },
    {
      ...
      render: (row) => {
        ...
        return (
          <div className="text-left text-gray-900 truncate pr-4" title={name}>
            {name}
          </div>
        );
      },
    ...
    <div>
      <div className="flex justify-between items-center gap-4">
        ...
        <div className="mb-6 shrink-0">
          <button
            ...
            className="flex items-center gap-2 whitespace-nowrap bg-gradient-to-r from-sky-500 to-sky-600 hover:from-sky-600 hover:to-sky-700 text-white px-6 py-2.5 rounded-full text-sm font-semibold shadow-md hover:shadow-lg transition-all cursor-pointer"
          >
      ...
      {isAddModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-white/60 backdrop-blur-sm p-4">
          <div className="bg-white border border-gray-800 rounded-[20px] w-full max-w-[550px] px-8 py-12 relative shadow-2xl overflow-y-auto hide-scrollbar">
            <button
