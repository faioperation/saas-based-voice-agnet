...
const HowItWorks = () => {
  const steps = [
    {
      icon: <Bot className="w-8 h-8 text-sky-950" />,
    ...
    {
      icon: <Brain className="w-8 h-8 text-sky-950" />,
    ...
    {
      icon: <Receipt className="w-8 h-8 text-sky-950" />,
    ...
    >
      <Container>
        <div className="mb-16 text-center max-w-4xl mx-auto flex flex-col items-center">
          ...
          >
            <span className="text-sky-950 font-inter text-[15px] sm:text-[16px] font-medium tracking-wide">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10">
          {steps.map((step, index) => (
            ...
            >
              ...
              <h3 className="text-sky-950 font-inter text-2xl font-bold tracking-tight leading-tight">
                {step.title}
              </h3>
              ...
              {step.slogan && (
                <div className="mt-auto pt-5 border-t border-sky-200">
