...
const CustomerCalls = () => {
  return (
    <div className="bg-linear-to-t from-[#59168B]/20 via-[#1C398E]/20 to-[#59168B]/20  text-sky-950 py-15">
      <Container className={`text-center lg:!w-[40%]`}>
        ...
        >
          ...
          <p className="text-sm md:text-lg text-sky-950 my-6">
          ...
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
            <Link to="/auth/login" onClick={() => setOpen(false)}>
              <button className="bg-sky-600 hover:bg-sky-700 rounded-full text-sky-950 font-bold text-base px-10 py-3  border border-[#0F42FF] ">
                Start Free Trial
              </button>
            </Link>
          </motion.div>
