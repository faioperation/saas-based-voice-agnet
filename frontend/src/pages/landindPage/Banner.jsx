      ...
      <Container>
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            {/* Heading */}
            <h1 className="text-3xl md:text-5xl font-bold  leading-[1.1] font-inter text-center md:text-start text-sky-950 flex flex-col">
            ...
            <div className="flex  items-center gap-4 pt-4">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="group relative px-2.5 md:px-8 py-4 bg-sky-600 hover:bg-sky-700 rounded-full text-sky-950 border border-[#0F42FF] font-medium font-inter text-base flex items-center gap-2  hover:shadow-[#0E41FE]/70 transition-all"
              >
                Start Free Trial
              ...
              <motion.button
                ...
                className="px-2.5 md:px-8 py-4 border border-sky-200 rounded-full text-sky-950 font-medium text-base flex items-center md:gap-3 gap-1 backdrop-blur-sm transition-all"
              >
                <div className="w-7 h-7  flex items-center justify-center">
                  <FiPlay className="text-sky-950" />
                </div>
                Watch Demo
              </motion.button>
            </div>
