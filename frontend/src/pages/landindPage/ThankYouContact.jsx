    ...
    <div className="bg-white min-h-screen flex flex-col">
      ...
      <div className="flex-grow flex items-center justify-center p-4">
        <div className="bg-gradient-to-br from-[#59168B]/20 to-[#1C398E]/20 border border-[#59168B]/30 p-10 rounded-3xl max-w-2xl w-full text-center shadow-[0_20px_50px_rgba(0,0,0,0.5)] backdrop-blur-xl">
          ...
          <Link
            to="/"
            className="inline-block bg-sky-600 hover:bg-sky-700 hover:from-[#001c80] hover:to-[#001870] border border-[#0F42FF] text-sky-950 font-medium py-3 px-8 rounded-full transition-all duration-300 shadow-[0_0_15px_rgba(15,66,255,0.4)] hover:shadow-[0_0_20px_rgba(15,66,255,0.6)]"
          >
            Back to Home
          </Link>
        </div>
