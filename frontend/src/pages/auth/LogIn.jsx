  ...
  return (
    <div className="flex flex-col items-center ">
      ...
      <form onSubmit={handleLogin} className="w-full flex flex-col gap-5">
        ...
        <div className="flex items-center justify-between mt-1 px-1">
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            />
            <span className="text-[12px] text-sky-700">Remember Me</span>
          </label>
          <Link
            to="/auth/forgot/password"
            className="text-[12px] text-sky-950 hover:text-[#2563EB] transition-colors"
          >
            Forgot Password?
          </Link>
        </div>
      ...
      {/* <div className="flex items-center w-full gap-4 mt-8 mb-6">
        ...
        <span className="text-[11px] text-sky-700 uppercase tracking-wider">Or Continue with</span>
        <div className="flex-1 h-[1px] bg-gray-800"></div>
      </div> */}
      ...
      {/* Sign Up Link */}
      {/* <div className="mt-8 text-[12px] text-sky-700">
